...
?>
<div class="col-lg-3 col-md-4 col-sm-12 col-12 mitra-card" data-href="<?=site_url('mitra/' . $mitra['id'])?>" style="cursor: pointer">
	<div class="card">
		<div class="card-body p-3">
			<div class="row">
				<div class="col-8" style="z-index: 100">
					<h2 class="mb-3 mt-2" style="color: #099543; font-weight: 800; font-size: 15pt;"><?=$judul?> </h2>			
					<hr class="mb-2 mt-0">
