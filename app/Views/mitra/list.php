...
<!------------------------------------------------->
<div class="header py-4" style="background-color: #099543">
						...
						<div class="row">
							<div class="col-md-2 col-sm-6 col-12">
								<div class="form-group mb-1">
									<label style="font-weight: 800" class="form-control-label text-dark mb-0">Kecamatan</label>
								...
								<div class="form-group mb-1">
									<label style="font-weight: 800" class="form-control-label text-dark mb-0">Kelurahan</label>
							...
							<div class="col-md-2 col-sm-6 col-12">
								<div class="form-group mb-1">
									<label style="font-weight: 800" class="form-control-label text-dark mb-0">Peran Ekonomi</label>
							...
							<div class="col-md-8 col-sm-12 col-12">
								<div class="row">
									<div class="col">
										<div class="form-group mb-1">
											<label style="font-weight: 800" class="form-control-label text-dark mb-0">Pencarian</label>
								...
								<div class="row">
									<div class="col-xl-6 col-lg-8 col-sm-6 col-6">
										<div class="form-group mb-1">
											<label style="font-weight: 800" class="form-control-label text-dark mb-1 d-block">Cari berdasarkan</label>
									...
									<div class="col-xl-3 col-lg-4 col-sm-6 col-6">
										<div class="form-group mb-1">
											<label style="font-weight: 800" class="form-control-label text-dark mb-1 d-block">Jumlah data/halaman</label>
											<div class="input-group input-group-merge input-group-sm">
									...
									<div class="col-xl-3 col-lg-4 col-sm-6 col-12">
										<div class="form-group mb-1">
											<label style="font-weight: 800" class="form-control-label text-dark mb-1 d-block">Halaman</label>
											<div class="input-group input-group-merge input-group-sm">
...
<div style="background: url('<?=site_url('images/background-logged.jpg')?>');">
	<div class="container-fluid">
...
<script type="text/javascript">
	...
	function loadKelurahan(kecamatan) {
		if (kecamatan == '') {
			...
			$("#filter-kelurahan").html("<option value=''>- Pilih Kelurahan -</option>")
			$.ajax({
				url: '<?=site_url('mitra/dynamic_form_kelurahan')?>',
				type: 'GET',
				dataType: 'html',
	...
	function refreshMitra() {
		...
		$.ajax({
			url: '<?=site_url('mitra/ajax_list/list-col-main')?>',
			type: 'GET',
			dataType: 'html',
			data: mitraParams,
		})
