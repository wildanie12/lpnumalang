				...
				<div class="card no-transform">
					...
					<div class="card-body">
						<div class="form-grup lpnu-form mb-2">
							<input type="text" name="judul" class="form-control" placeholder="Tuliskan judul disini..." value="<?=$halaman['judul']?>">
							<div class="invalid-feedback invalid-feedback-judul font-italic" style="display: none"></div>
						</div>
						<div class="form-group lpnu-form">
							<input type="hidden" name="daftar_gambar" value="<?=$halaman['daftar_gambar']?>">
							<textarea name="artikel" id="artikel" rows="8"><?=file_get_contents('./files/postingan/halaman/' . $halaman['file_artikel'])?></textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card-body pb-0 pt-3">
						...
						<div class="row">
							<div class="form-group col">
								...
								<textarea class="form-control" name="deskripsi_penelusuran" rows="3"><?=$halaman['deskripsi_penelusuran']?></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col">
